# Catálogo de ejercicios de LiftLog (ids válidos para `exerciseId`)

> Generado por `scripts/build-exercise-catalog.js` desde `src/data/exercises.json` (892 ejercicios). No editar a mano.
>
