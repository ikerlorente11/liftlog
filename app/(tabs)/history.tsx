// Historial: feed de entrenos realizados (tarjetas) + resumen semanal.
...
export default function HistoryScreen() {
  ...
  return (
    <Screen>
      <Header title="Historial" right={<HeaderButton icon="calendar-outline" onPress={() => router.push('/settings/calendar')} color={c.text} />} />
      <FlatList
        data={workouts}
        keyExtractor={(w) => w.id}
        ...
        ListEmptyComponent={
          <EmptyState
            ...
            action={<Button label="Ir a rutinas" variant="secondary" onPress={() => router.push('/')} />}
          />
        }
      />
      <ActionSheet
