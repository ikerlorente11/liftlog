...
| **Programas por semanas** | Una rutina puede llevar un plan de N semanas con fases (bloques, descargas, tests): la app calcula la semana actual, muestra "Semana X/N · Bloque" y carga los objetivos de la fase al entrenar; descargas = mitad de series automática; selector "Cambiar semana". **Pausar el plan** (Ajustes): eliges el primer día que vuelve a contar y hasta entonces lo que entrenas se registra pero no avanza el plan ni cambia la rutina. |
...
| **Medidas** | Composición corporal (peso, grasa, masa muscular, proteínas, agua, mineral óseo, grasa visceral, metabolismo basal) y perímetros; cualquier masa se apunta en kg o en % del peso (como la da la báscula) y la app la convierte con el peso de ese origen y día, con gráfica por origen e historial; pantalla **Evolución** con diferencias entre mediciones al estilo del informe de un nutricionista. **Configurar medidas**: añade, renombra, ordena u oculta campos y orígenes (báscula de casa, nutricionista, los que quieras, cada uno con su color); quitar algo con datos solo lo oculta. |
